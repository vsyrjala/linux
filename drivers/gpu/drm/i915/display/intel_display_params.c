...
intel_display_param_named_unsafe(dsb_vblank_n, int, 0400,
	"vblank dsb test hax (default: 0)");
...
intel_display_param_named_unsafe(vblank_delay, int, 0400,
	"Override vblank delay (default: -1 (automatic))");

intel_display_param_named_unsafe(framestart_delay, int, 0400,
	"Override framestart delay (default: -1 (automatic))");

intel_display_param_named_unsafe(min_cdclk, int, 0400,
	"Minimum CDCLK frequency (default: 0)");
